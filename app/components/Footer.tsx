      ...
      <Container>
        <div className="py-16">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-white text-lg font-semibold">LearnHub</h3>
              <p className="mt-4 text-slate-400">Advancing careers through expert-led courses and professional certifications.</p>
            ...
            <div>
              ...
              <ul className="mt-4 space-y-4">
                <li><Link href="/categories/technology" className="text-slate-400 hover:text-white">Technology</Link></li>
                <li><Link href="/categories/business" className="text-slate-400 hover:text-white">Business</Link></li>
                <li><Link href="/categories/health-safety" className="text-slate-400 hover:text-white">Health & Safety</Link></li>
                <li><Link href="/categories/construction" className="text-slate-400 hover:text-white">Construction</Link></li>
                <li><Link href="/categories/security" className="text-slate-400 hover:text-white">Security</Link></li>
              </ul>
            </div>
            <div>
        ...
        <div className="border-t border-slate-700 pt-8 pb-12">
          <p className="text-slate-400 text-center">&copy; 2025 LearnHub. All rights reserved.</p>
        </div>
      </Container>
    </footer>
  );
