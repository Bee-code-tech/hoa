      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-12">
        <div className="max-w-2xl mx-auto px-4 text-center">
          <div className="bg-white rounded-2xl shadow-xl p-8 transform transition-all duration-300 hover:shadow-2xl">
            ...
            <p className="text-gray-600 mb-8 text-lg">Add some courses to your cart before checking out.</p>
            <Link href="/">
              <Button variant="primary" color="blue" className="px-8 py-3 text-lg">
                Browse Courses
              </Button>
            </Link>
          </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-12">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <p className="text-gray-600 mb-8">Please review your order details before proceeding to payment</p>
        
        <div className="bg-white rounded-2xl shadow-xl p-6 mb-8">
          <h2 className="text-2xl font-semibold text-gray-900 mb-6 pb-2 border-b border-gray-100">Order Summary</h2>
            ...
            {cart.map((item) => (
              <div key={item.id} className="flex justify-between items-center p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors">
                <div className="flex items-center space-x-4">
                  <div className="bg-gradient-to-br from-blue-500 to-indigo-600 rounded-lg w-16 h-16 flex items-center justify-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-between">
          <Link href="/">
            <Button variant="outline" color="slate" className="px-8 py-3 text-lg">
              ← Continue Shopping
            </Button>
          </Link>
